...
CREATE TABLE `cases` (
  ...
  `court_name` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `lawyer_id_assigned` INT(11) NOT NULL,
  `lawyer_status` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'not yet accepted',
...
CREATE TABLE `client` (
  ...
  `client_email` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `client_password` VARCHAR(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `phone_no` INT(11) DEFAULT NULL,
...
CREATE TABLE `lawyer_login` (
  ...
  `lawyer_email` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `lawyer_password` VARCHAR(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `lawyer_phone_no` INT(11) DEFAULT NULL,
  `lawyer_city` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `lawyer_address` VARCHAR(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `lawyer_rating` INT(11) DEFAULT NULL,
  `specialization` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `lawyer_image` BLOB
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE notifications (
    ...
    accepted_status VARCHAR(255) NOT NULL
); ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
